...
- Don't care about backwards compatibility in links for the site.
- For the static site UI the data model must be designed first. If the user asks to implement something UI-related always check if the data model is already designed and the samples are generated. If not, stop an ask. 
